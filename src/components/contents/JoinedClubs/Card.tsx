...
export default function Card(props: IProps) {
  ...
  return (
    <div className="px-10 py-8 flex flex-col items-center bg-neutral-800 drop-shadow-lg max-w-md rounded-lg max-[640px]:w-[80svw] cursor-pointer hover:scale-110 transform-gpu duration-700 min-h-full">
